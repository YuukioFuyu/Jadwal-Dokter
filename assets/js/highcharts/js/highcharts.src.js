 ...
 *
 * License: www.siahli.com/license
 */
...
function error(code, stop) {
	var msg = 'Highcharts error #' + code + ': www.siahli.com/errors/' + code;
	if (stop) {
		throw msg;
	} else if (win.console) {
		console.log(msg);
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.siahli.com/4.0.1/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.siahli.com/4.0.1/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
