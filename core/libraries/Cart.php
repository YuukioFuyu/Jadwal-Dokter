...
class RAST_Cart {
	...
	public function __construct($params = array())
	{
		...
		$this->RAST->load->driver('session', $config);

		$this->_cart_contents = $this->RAST->session->userdata('cart_contents');
	...
	protected function _save_cart()
	{
		...
		{
			$this->RAST->session->unset_userdata('cart_contents');

			return FALSE;
		}

		$this->RAST->session->set_userdata(array('cart_contents' => $this->_cart_contents));
