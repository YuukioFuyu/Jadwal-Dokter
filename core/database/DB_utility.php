...
abstract class RAST_DB_utility {
	...
	{
		$this->db =& $db;
		log_message('info', 'RAST Database Utility Class Initialized');
	}
	...
	public function backup($params = array())
	{
		...
		if ($prefs['format'] === 'zip')
		{
			...
			$RAST =& get_instance();
			$RAST->load->library('zip');
			$RAST->zip->add_data($prefs['filename'], $this->_backup($prefs));
			return $RAST->zip->get_zip();
		}
