...
abstract class RAST_DB_driver {
	...
	public function __construct($params)
	{
		...
		log_message('info', 'RAST Database Driver Class Initialized');
	}
	...
	{
		$driver = 'RAST_DB_'.$this->dbdriver.'_result';
	...
	{
		if ( ! class_exists('RAST_DB_Cache', FALSE))
		{
		...
		$this->CACHE = new RAST_DB_Cache($this); // pass db object to support multiple db connections and returned db objects
		return TRUE;
	}
